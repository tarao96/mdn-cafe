...
<div class="wrapper">
  ...
  <div class="container w-full mx-auto pt-20 pb-20 px-6 md:px-0">
    ...
    <div class="mx-auto mb-10 text-center">
      <nuxt-link to="/"
          class="rounded-lg px-4 md:px-5 xl:px-4 py-3 md:py-4 xl:py-3 bg-white
              hover:bg-gray-200 md:text-lg xl:text-base text-gray-800 font-semibold
              leading-tight shadow-md">トップへ戻る</nuxt-link>
    </div>
  </div>
</div>
</template>
